! function() {
    ...
    var o = window.document,
        ...
        u = function(o, e) { for (var t = 0, r = o.length; t < r; t++) e(o[t]) },
        f = function(o) {
            return function(e, t, r) {
                ...
                return null != r && u(r, (function(e) { a.appendChild("string" == typeof e ? o.createTextNode(e) : e) })), a
            }
        },
        h = f(o),
        g = function(o) { var e; return function() { e || (e = 1, o.apply(this, arguments)) } },
        b = function(o, e) { return {}.hasOwnProperty.call(o, e) },
        p = function(o) { return ("" + o).toLowerCase() },
        v = function(o, e, t, r) {
        ...
        m = function(o, e, t) { o.addEventListener ? o.addEventListener(e, t, !1) : o.attachEvent("on" + e, t) },
        w = function(o, e, t) { o.removeEventListener ? o.removeEventListener(e, t, !1) : o.detachEvent("on" + e, t) },
        k = function(o, e, t) {
            var r = function() { return w(o, e, r), t.apply(this, arguments) };
            m(o, e, r)
        },
        x = function(o, e, t) {
            if (null != o.readyState) {
                var r = "readystatechange",
                    a = function() { if (e.test(o.readyState)) return w(o, r, a), t.apply(this, arguments) };
                m(o, r, a)
            }
        },
        ...
        C = function(o, e) { return "@media(prefers-color-scheme:" + o + "){" + y[b(y, e) ? e : o] + "}" },
        ...
        F = function(o, e) {
            var t = A[o] || (A[o] = []);
            if (!(t.push(e) > 1)) {
                var r = g((function() { for (delete A[o]; e = t.shift();) e.apply(null, arguments) }));
                if (d) {
                    var n = new a;
                    m(n, "abort", r), m(n, "error", r), m(n, "load", (function() {
                        var o;
                        try { o = JSON.parse(this.responseText) } catch (o) { return void r(o) }
                        r(200 !== this.status, o)
                    })), n.open("GET", o), n.send()
                } else {
                    var i = this || window;
                    i._ = function(o) { i._ = null, r(200 !== o.meta.status, o.data) };
        ...
        L = function(o, e, t) {
            ...
            if (((u === c || u === "gist." + c) && "archive" === h[3] || u === c && "releases" === h[3] && ("download" === h[4] || "latest" === h[4] && "download" === h[5]) || u === "codeload." + c) && (d.target = "_top"), "true" === p(e["data-show-count"]) && u === c && "marketplace" !== h[1] && "sponsors" !== h[1] && "orgs" !== h[1] && "users" !== h[1] && "-" !== h[1]) {
                ...
                F.call(this, l + w, (function(o, e) {
                    if (!o) {
                        var a = e[m];
                        s.appendChild(r("a", { className: "social-count", href: e.html_url + g, rel: "noopener", target: "_blank", "aria-label": a + " " + m.replace(/_count$/, "").replace("_", " ").slice(0, a < 2 ? -1 : void 0) + " on GitHub" }, [("" + a).replace(/\B(?=(\d{3})+(?!\d))/g, ",")]))
                    }
                    t(s)
                }))
            } else t(s)
        ...
        E = function(o) { return (_ > 1 ? t.ceil(t.round(o * _) / _ * 2) / 2 : t.ceil(o)) || 0 },
        G = function(o, e) { o.style.width = e[0] + "px", o.style.height = e[1] + "px" },
        T = function(e, r) {
            if (null != e && null != r)
                if (e.getAttribute && (e = function(o) {
                    ...
                    var a = h("span");
                    L(a.attachShadow({ mode: "closed" }), e, (function() { r(a) }))
                } else {
                    ...
                    var c = function() {
                        ...
                        try { a = l.document.body } catch (e) { return void o.body.appendChild(n.parentNode.removeChild(n)) }
                        w(n, "load", c), L.call(l, a, e, (function(o) {
                            ...
                            n.parentNode.removeChild(n), k(n, "load", (function() { G(n, a) })), n.src = i + "#" + (n.name = function(o, e, t, r) {
    ...
    e.protocol + "//" + e.host + e.pathname === i ? L(o.body, v(window.name || e.hash.replace(/^#/, "")), (function() {})) : function(e) {
        ...
        var e, t = o.querySelectorAll ? o.querySelectorAll("a." + n) : (e = [], u(o.getElementsByTagName("a"), (function(o) {-1 !== (" " + o.className + " ").replace(/[ \t\n\f\r]+/g, " ").indexOf(" " + n + " ") && e.push(o) })), e);
        u(t, (function(o) { T(o, (function(e) { o.parentNode.replaceChild(e, o) })) }))
    }))
}();
