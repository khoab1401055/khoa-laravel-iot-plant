            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form  class="mb-3" method="POST"  action="{{ route('register') }}" id="register">
                            @csrf
                            <div class="mb-3">
                            ...
                            <button class="btn btn-primary d-grid w-100" type="button" onclick="submitForm('register')">Sign up</button>
                        </form>
