                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <button class="btn d-flex align-items-center" type="button"
                                            data-bs-toggle="modal" data-bs-target="#add_model">
                        ...
                        <div class="card h-100">
                            <div class="square-image">
                                <img class="card-img-top"
                                    src="{{ asset('images/undraw_artificial_intelligence_re_enpp.svg') }}"
                                    alt="Default Image">
                            </div>
                                ...
                                @if ($sensorNode->devices && count($sensorNode->devices) > 0)
                                    <ul>
                                        @foreach ($sensorNode->devices as $device)
                                            <li class="card-text small">{{ $device->devicesDescription->name }}</li>
                                        @endforeach
                                    </ul>
                                @else
