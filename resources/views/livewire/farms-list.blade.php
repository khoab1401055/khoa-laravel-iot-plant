                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text d-flex align-items-center justify-content-between">
                                ...
                                <small class="ml-auto text-muted">{{ \Carbon\Carbon::parse($farm->updated_at)->isoFormat('MMM YYYY') }}
                                </small>
                            </p>
                            <div class="dropdown-divider mb-2"></div>
                            <a href="{{ route('goto.farm',$farm->name_code) }}" class="btn btn-primary mt-3 ml-auto">{{ __('messages.go_to_farm') }}</a>
                        </div>
