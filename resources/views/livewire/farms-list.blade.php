            ...
            <div class="card h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <p class="card-text d-flex align-items-center justify-content-between">
                        <small class="text-muted"><i class='bx bxs-user-circle' ></i> {{ $farm->customer ? $farm->customer->name : '' }}</small>
                        <small class="ml-auto text-muted">{{ date('M-Y', strtotime($farm->updated_at)) }}  </small>
                    </p>
                    <div class="dropdown-divider mb-2"></div>
                    <a href="javascript:void(0)" class="btn btn-primary mt-3 ml-auto">Go To Farm</a>
                  </div>
